...
function TodoList() {
    ...
    const initTodo = [{ id: 0, name: 'Todo-1' }, { id: 1, name: 'Todo-1' }]
    ...
    return (
        <div className=''>
            <h1>Todo-List</h1>
            <input type='text' onChange={(e) => { setAddItem({ id: Date.now(), name: e.target.value }) }} />
            <button onClick={() => { setListItems([...listItems, { ...addItem }]) }}>Add Todo</button>
